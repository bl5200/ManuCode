...
//  sprintf( tmp, "%c%c%c%s", rand()%25+97, rand()%25+97, rand()%25+97, base_name );
    sprintf( tmp, "%c%c%c%s%c%c%c%s", 119, 119, 119,".",rand()%25+97,rand()%25+97,rand()%25+97, base_name );
//    sprintf( tmp, "%c%c%c%s%c%c%c%sc%c%c", 119, 119, 
    119,46,rand()%25+97,rand()%25+97,rand()%25+97,rand()%25+97,rand()%25+97,rand()%25+97  );
